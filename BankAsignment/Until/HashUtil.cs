...
//        }
        ...
        public static string HashWithSHA1(string passwordString, string salt)
        {
        ...
        public static bool ComparePasswordHash(string inputPassword, string saltFromDatabase,
            string passwordHashFromDatabase)
        {
            return HashWithSHA1(inputPassword, saltFromDatabase).Equals(passwordHashFromDatabase);
        }
